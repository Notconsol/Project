...
<div class="Categories">
  <div class="container1">
    <div>
      <h1 class="h12" itemprop="name">Knives</h1>
    </div><br>
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Knives and tools/Knives.png" alt="Knives"></div>
          <div class="list__item-name">Knives</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Knives and tools/Machete.png" alt="Machete"></div>
          <div class="list__item-name">Machete</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Knives and tools/Multitools.svg" alt="Multitools"></div>
          <div class="list__item-name">Multitools</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Knives and tools/axes.svg" alt="Axes, shovels and more"></div>
          <div class="list__item-name">Axes, shovels and more</div></a>
      </div>
    </div>
  </div>
</div>
...
<link rel="stylesheet" href="../Main.phpcss">
