...
<div  class="menu">
	...
	<div class="act">
		<a href="all-reviews.php"><img src="../img/heart.png" alt="" width="23px" class="icon"></a>
	</div>
</div><!-- Same everywhere -->
    ...
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/More/Lights.svg" alt="Lights"></div>
          <div class="list__item-name">Lights</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/More/Safes.svg" alt="Safes"></div>
          <div class="list__item-name">Weapon Safes</div></a>
        <a href="#" class="list__item" >
          <div class="block"><img src="../img/More/Cleaning & Care.svg" alt="Cleaning & Care"></div>
          <div class="list__item-name">Cleaning & Care</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/More/Accessories.svg" alt="Revolvers"></div>
          <div class="list__item-name">Accessories</div></a>
      </div>
    </div>
  </div>
</div>
