...
<div class="Categories">
  <div class="container1">
    <div>
      <h1 class="h12" itemprop="name">Weapon</h1>
    </div><br>
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Weapon/Firearms.png" alt="Firearms"></div>
          <div class="list__item-name">Firearms</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Weapon/Air guns.png" alt="Air guns"></div>
          <div class="list__item-name">Air guns</div></a>
        <a href="#" class="list__item" >
          <div class="block"><img src="../img/Weapon/Traumatic weapon.png" alt="Traumatic weapon"></div>
          <div class="list__item-name">Traumatic weapon</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Weapon/Revolvers.png" alt="Revolvers"></div>
          <div class="list__item-name">Revolvers</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Weapon/Flare pistols.png" alt="Flare pistols"></div>
          <div class="list__item-name">Flare pistols</div></a>
      </div>
    </div>
  </div>
</div>
