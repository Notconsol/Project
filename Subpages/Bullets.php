...
<div class="Categories">
  <div class="container1">
    <div>
      <h1 class="h12" itemprop="name">Bullets</h1>
    </div><br>
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Bullets/Smoothbore cartridges.png" alt="Smoothbore cartridges"></div>
          <div class="list__item-name">Smoothbore cartridges</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Bullets/fifled weapons.png" alt="Cartridges for fifled weapons"></div>
          <div class="list__item-name">Cartridges for fifled weapons</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Bullets/traumatic weapons.png" alt="Ammunition for traumatic weapons"></div>
          <div class="list__item-name">Ammunition for traumatic weapons</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Bullets/Flare rounds.png" alt="Flare rounds"></div>
          <div class="list__item-name">Flare rounds</div></a>
      </div>
    </div>
  </div>
</div>
...
<div class="info">
	<div class="information other">
		<div class="text-photo">
			<img src="../img/Bullets/toClients.png" alt="" width="25px">
