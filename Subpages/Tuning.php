...
<div class="Categories">
  <div class="container1">
    <div>
        <h1 class="h12" itemprop="name">Tuning</h1>
    </div><br>
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Tuning/Adjustable Stocks.png" alt="Adjustable Stocks"></div>
          <div class="list__item-name">Adjustable Stocks</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Tuning/Handguard.png" alt="Observation"></div>
          <div class="list__item-name">Handguard</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Tuning/Magazines.svg" alt="Magazines"></div>
          <div class="list__item-name">Magazines</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Tuning/Pistol grip.svg" alt="Bipod"></div>
          <div class="list__item-name">Pistol grip</div></a>
      </div>
    </div>
  </div>
</div>
