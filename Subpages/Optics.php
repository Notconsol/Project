...
<div class="Categories">
  <div class="container1">
    <div>
        <h1 class="h12" itemprop="name">Optics</h1>
    </div><br>
    <div class="list">
      <div class="list__inner">
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Optics/Sights.png" alt="Sights"></div>
          <div class="list__item-name">Sights</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Optics/Observation.png" alt="Observation"></div>
          <div class="list__item-name">Observation devices</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Optics/NVB.png" alt="Night vision sights & devices (NVB)"></div>
          <div class="list__item-name">Night vision sights & devices (NVB)</div></a>
        <a href="#" class="list__item">
          <div class="block"><img src="../img/Optics/Mounting.png" alt="Mounting"></div>
          <div class="list__item-name">Mounting</div></a>
      </div>
    </div>
  </div>
</div>
